...
namespace MusicApp.Infrastructure.Migrations
{
    ...
    [Migration("20241017142828_AddFileUpload")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicApp.Domain.Entities.FileUpload", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("MusicApp.Domain.Entities.Track", b =>
                {
                    b.HasOne("MusicApp.Domain.Entities.FileUpload", "AudioFile")
                        .WithMany()
                        .HasForeignKey("AudioFileId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MusicApp.Domain.Entities.FileUpload", "CoverImage")
                        .WithMany()
